...
class KodakEnduraPremier(FilmSpectral):
    def __init__(self, *args, **kwargs):
        ...
        self.green_log_sensitivity = {420.5110: -0.8987, 431.6891: -0.8124, 442.3350: -0.6454, 444.8190: -0.5966,
                                      ...
                                      584.9894: -1.6961}
        self.blue_log_sensitivity = {380.4116: 0.0657, 385.3797: 0.2439, 389.8155: 0.3340, 397.2676: 0.5253,
        ...
        self.red_log_exposure = np.array(
            [-3.0000, -1.9802, -1.8642, -1.7542, -1.6501, -1.5610, -1.4584, -1.3826, -1.2993, -1.2131, -1.1581, -1.0585,
             -1.0302, -0.9856, -0.9395, -0.8756, -0.7924, -0.6838, -0.5411, -0.3776, -0.2379, -0.1487])
        self.red_density_curve = np.array(
            [0.1100, 0.1130, 0.1278, 0.1635, 0.2393, 0.3449, 0.5619, 0.7582, 1.0525, 1.4182, 1.6769, 2.1169, 2.2180,
             2.3459, 2.4529, 2.5659, 2.6596, 2.7161, 2.7428, 2.7636, 2.7547, 2.7413])
        self.green_log_exposure = np.array(
            [-3.0015, -1.9683, -1.8345, -1.7364, -1.6487, -1.5461, -1.4420, -1.3543, -1.2815, -1.2384, -1.2101, -1.1700,
             -1.1001, -1.0362, -0.9604, -0.8697, -0.7849, -0.7255, -0.6630, -0.5114, -0.3687, -0.2468, -0.1487])
        self.green_density_curve = np.array(
            [0.0833, 0.0892, 0.1056, 0.1442, 0.2126, 0.3612, 0.5976, 0.9068, 1.2190, 1.4034, 1.5223, 1.6799, 1.9415,
             2.1348, 2.2805, 2.3979, 2.4559, 2.4797, 2.4945, 2.5168, 2.5302, 2.5302, 2.5213])
        ...
        red_spectral_density = {400.0000: 0.1257, 421.7812: 0.0629, 449.3708: 0.0314, 495.2565: 0.0411,
                                533.8819: 0.0943, 562.7783: 0.2454, 582.0910: 0.4352, 600.0968: 0.6987,
                                608.8093: 0.8184, 619.8451: 0.9055, 635.9632: 0.9707, 643.9497: 0.9961,
                                648.3059: 1.0058, 654.8403: 0.9901, 661.6651: 0.9454, 669.9419: 0.8583,
                                677.3475: 0.7423, 688.6738: 0.5670, 700.0000: 0.4231}
        green_spectral_density = {400.2904: 0.0834, 418.0058: 0.0592, 437.7541: 0.0641, 459.5353: 0.1257,
                                  478.8480: 0.2599, 501.6457: 0.5319, 511.2294: 0.6746, 520.8132: 0.7967,
                                  534.1723: 0.9224, 543.6108: 0.9828, 548.4027: 1.0034, 554.7919: 0.9889,
                                  560.4550: 0.9429, 567.7154: 0.8245, 577.4443: 0.6165, 590.9487: 0.3433,
                                  600.2420: 0.2164, 611.4230: 0.1209, 629.1384: 0.0532, 658.1801: 0.0181,
                                  699.7096: 0.0121}
        blue_spectral_density = {400.2904: 0.5924, 414.6660: 0.7773, 424.8306: 0.8897, 431.9458: 0.9562,
                                 436.5924: 0.9865, 441.2391: 1.0022, 446.7570: 0.9973, 454.3078: 0.9695,
                                 462.7299: 0.9067, 474.4918: 0.7592, 496.1278: 0.4183, 509.4869: 0.2490,
                                 520.0871: 0.1584, 532.4298: 0.0943, 553.3398: 0.0411, 584.9952: 0.0097,
                                 699.7096: 0.0085}
