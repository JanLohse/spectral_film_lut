...
from PyQt6.QtWidgets import QApplication, QMainWindow, QComboBox, QGridLayout, QSizePolicy, QCheckBox, QProgressBar, \
    QVBoxLayout
...
class MainWindow(QMainWindow):
    def __init__(self, filmstocks):
        ...
        self.negative_selector = FilmStockSelector(filmstock_info, sort_keys=sort_keys, group_keys=group_keys,
                                                   list_keys=list_keys, sidebar_keys=sidebar_keys,
...
def main():
    ...
    window = MainWindow(loaded_filmstocks)
    window.show()
    splash.close()
